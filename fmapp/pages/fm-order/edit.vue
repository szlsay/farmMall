  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("oid,create_time,update_time,cancel_time,price_amount_total,state,order_goodslist,order_delivery").get().then((res) => {
