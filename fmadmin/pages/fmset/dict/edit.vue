  ...
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      ...
      <uni-forms-item name="description" label="备注">
        <uni-easyinput placeholder="请填写备注" v-model="formData.description" trim="both"></uni-easyinput>
      </uni-forms-item>
...
<script>
  import { validator } from '@/js_sdk/validator/fm-dict.js';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("title,type,description,enum").get().then((res) => {
