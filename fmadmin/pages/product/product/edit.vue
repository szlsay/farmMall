	...
	<view class="uni-container">
		<uni-forms ref="form" :model="formData" validateTrigger="bind">
			...
			<uni-forms-item name="yield_ratio" label="出成率">
				<picker @change="pickerChange($event, 'yield_ratio')" :range="formOptions.yield_ratio_data"
					:value="formOptions.yield_ratio_index">
			...
			<uni-forms-item name="quality_ratio" label="质信金">
				<picker @change="pickerChange($event, 'quality_ratio')" :range="formOptions.quality_ratio_data"
					:value="formOptions.quality_ratio_index">
			...
			<uni-forms-item name="fixed_ratio" label="定倍率">
				<picker @change="pickerChange($event, 'fixed_ratio')" :range="formOptions.fixed_ratio_data"
					:value="formOptions.fixed_ratio_index">
			...
			<uni-forms-item name="platform_fee" label="平台佣金">
				<picker @change="pickerChange($event, 'platform_fee')" :range="formOptions.platform_fee_data"
					:value="formOptions.platform_fee_index">
