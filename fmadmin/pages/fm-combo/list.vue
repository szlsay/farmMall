<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="name,unit,image,image_content,sku,sell_price,delivery_rate,delivery_timer,reserve_begin,reserve_end,description" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'unit')" sortable @sort-change="sortChange($event, 'unit')">产品单位</uni-th>
            ...
            <uni-th align="center" filter-type="range" @filter-change="filterChange($event, 'sell_price')" sortable @sort-change="sortChange($event, 'sell_price')">售价</uni-th>
            ...
            <uni-th align="center" sortable @sort-change="sortChange($event, 'delivery_timer')">配送次数</uni-th>
            <uni-th align="center" filter-type="timestamp" @filter-change="filterChange($event, 'reserve_begin')" sortable @sort-change="sortChange($event, 'reserve_begin')">预订开始时间</uni-th>
            <uni-th align="center" filter-type="timestamp" @filter-change="filterChange($event, 'reserve_end')" sortable @sort-change="sortChange($event, 'reserve_end')">预订结束时间</uni-th>
