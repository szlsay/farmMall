<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="name,unit,image,image_content,sku,price_sell,expiry,reserve_begin,reserve_end,delivery,description" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" filter-type="date" @filter-change="filterChange($event, 'reserve_begin')" sortable @sort-change="sortChange($event, 'reserve_begin')">预定开始时间</uni-th>
            <uni-th align="center" filter-type="date" @filter-change="filterChange($event, 'reserve_end')" sortable @sort-change="sortChange($event, 'reserve_end')">预定结束时间</uni-th>
