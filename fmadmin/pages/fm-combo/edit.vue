  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("name,unit,image,image_content,sku,price_sell,expiry,reserve_begin,reserve_end,delivery,description").get().then((res) => {
