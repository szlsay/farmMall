      ...
      <unicloud-db ref="udb" :collection="collectionList" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'producer')" sortable @sort-change="sortChange($event, 'producer')">商品产地</uni-th>
            ...
            <uni-th align="center" sortable @sort-change="sortChange($event, 'sku')">商品规格</uni-th>
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/fm-goods.js';
