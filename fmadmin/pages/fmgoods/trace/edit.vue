  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("name,made_company,province_code,city_code,area_code,province_name,city_name,area_name,made_address,create_time,expire_time,image_produce,image_report").get().then((res) => {
