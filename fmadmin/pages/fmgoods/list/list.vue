<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="image,source_type,name,producer,description,unit,price_cost,price_original,price_sell,stock,storage" :where="where" page-data="replace"
