    ...
    methods: {
     ...
     /**
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("image,name,producer,unit,price_cost,price_original,price_sell,source_type,stock,storage,expiry,buy_min,buy_max,description,image_content").get().then((res) => {
