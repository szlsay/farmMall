<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="land_name,land_type,contact_name,contact_phone,map_address,address,longitude,latitude,path,image_content,video,disabled" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'contact_name')" sortable @sort-change="sortChange($event, 'contact_name')">负责人姓名</uni-th>
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'contact_phone')" sortable @sort-change="sortChange($event, 'contact_phone')">负责人电话</uni-th>
            ...
            <uni-th align="center" sortable @sort-change="sortChange($event, 'path')">圈地范围</uni-th>
          ...
          <uni-tr v-for="(item,index) in data" :key="index">
            <uni-td align="center">{{item.land_name}}</uni-td>
            <uni-td align="center">{{item.land_type}}</uni-td>
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/st-land.js';
