<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      ...
      <uni-forms-item name="path" label="圈地范围">
        <uni-data-checkbox :multiple="true" v-model="formData.path"></uni-data-checkbox>
      </uni-forms-item>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("land_name,land_type,contact_name,contact_phone,map_address,address,longitude,latitude,path,image_content,video,disabled").get().then((res) => {
