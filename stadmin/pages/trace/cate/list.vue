<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="label,image,disabled,parent_id,level,pinyin" :where="where" page-data="replace"
...
<script>
  import { enumConverter, filterToWhere } from '@/js_sdk/validator/st-product-cate.js';
  ...
  export default {
    data() {
      return {
        collectionList: "st-product-cate",
        query: '',
        where: '',
        orderby: dbOrderBy,
        orderByFieldName: "",
