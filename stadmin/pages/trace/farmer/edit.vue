<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      <uni-forms-item name="farmer_name" label="农户姓名" required>
        <uni-easyinput placeholder="请输入农户姓名" v-model="formData.farmer_name" trim="both"></uni-easyinput>
      </uni-forms-item>
      <uni-forms-item name="contact_phone" label="联系电话" required>
        <uni-easyinput placeholder="请输入联系电话" v-model="formData.contact_phone" trim="both"></uni-easyinput>
      </uni-forms-item>
      ...
      <uni-forms-item name="image" label="农户个人图片">
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("farmer_name,contact_phone,map_address,address,longitude,latitude,image,disabled").get().then((res) => {
