	...
	<view class="uni-container">
		<uni-forms ref="form" :model="formData" validateTrigger="bind">
			...
			<view class="st-box">
				...
				<uni-row>
					<uni-col :xs="24" :sm="8">
						<uni-forms-item name="farmer_name" label="农户姓名" required :label-width="labelWidth" label-align="right">
							<uni-easyinput placeholder="请输入农户姓名" v-model="formData.farmer_name" trim="both"
								maxlength="10"></uni-easyinput>
						</uni-forms-item>
					</uni-col>
					<uni-col :xs="24" :sm="8">
						<uni-forms-item name="contact_phone" label="联系电话" required :label-width="labelWidth" label-align="right">
							<uni-easyinput placeholder="请输入联系电话" v-model="formData.contact_phone" trim="both"
								maxlength="11"></uni-easyinput>
						</uni-forms-item>
					</uni-col>
					<uni-col :xs="24" :sm="8">
						<uni-forms-item name="image" label="农户图片" :label-width="labelWidth" label-align="right">
...
<script>
	import {
		validator
	} from '@/js_sdk/validator/st-farmer.js';
	...
	const dbCollectionName = 'st-farmer';
		...
		methods: {
			...
			getDetail(id) {
				...
				db.collection(dbCollectionName).doc(id).field(
						"farmer_name,contact_phone,map_address,address,longitude,latitude,image,disabled")
					.get()
					.then((res) => {
