<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      <uni-forms-item name="coop_name" label="合作社名称" required>
      ...
      <uni-forms-item name="contact_phone" label="联系人电话">
...
<script>
  import { validator } from '@/js_sdk/validator/st-coop.js';
