	...
	<view>
		...
		<view class="uni-container">
			<unicloud-db ref="udb" :collection="collectionList"
				field="crop_name,cate_id,land_id,standard_type,plant_num,plant_start_time,pick_time" :where="where"
				...
				<uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe
					...
					<uni-tr>
						...
						<uni-th align="center" filter-type="search"
							@filter-change="filterChange($event, 'standard_type')" sortable
							@sort-change="sortChange($event, 'standard_type')">种植标准</uni-th>
						<uni-th align="center" filter-type="range" @filter-change="filterChange($event, 'plant_num')"
							sortable @sort-change="sortChange($event, 'plant_num')">数量</uni-th>
						<uni-th align="center" filter-type="timestamp"
							@filter-change="filterChange($event, 'plant_start_time')" sortable
							@sort-change="sortChange($event, 'plant_start_time')">开始时间</uni-th>
						<uni-th align="center" filter-type="timestamp"
							@filter-change="filterChange($event, 'pick_time')" sortable
							@sort-change="sortChange($event, 'pick_time')">收获时间</uni-th>
